...
const services = [
  { icon: 'verified', title: 'Social Media Verification', desc: 'Secure the blue badge on all major platforms through official white-glove channels.', color: 'secondary-container', href: '/services/verification' },
  ...
  { icon: 'lock_reset', title: 'Account Recovery', desc: 'Specialized technical support to recover compromised or disabled high-value accounts.', color: 'secondary-container', href: '/services/recovery' },
  ...
  return (
    <main>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-24 overflow-hidden bg-slate-950">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-secondary-container/5 rounded-full blur-[140px]" />
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-secondary/10 rounded-full blur-[120px]" />

        <div className="max-w-7xl mx-auto px-6 text-center z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-secondary-container/5 border border-secondary-container/10 mb-10 fade-in-up">
      ...
      <section className="py-12 bg-surface-container-low/20 overflow-hidden relative border-y border-white/5">
        <div className="flex flex-col gap-8">
          ...
          <div className="relative flex overflow-x-hidden">
            ...
            <div className="animate-scroll whitespace-nowrap flex items-center gap-12 md:gap-16 py-3">
      ...
      <section className="py-28 px-6 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-6xl font-display text-white tracking-tight mb-6 leading-tight">Elite Digital <span className="text-accent">Services</span></h2>
            <p className="text-on-surface-variant text-lg">Curated solutions for those who demand the highest standards in digital asset management and authority.</p>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((s, i) => (
            ...
            >
              ...
              <div>
                <div className={`w-12 h-12 rounded-xl bg-secondary-container/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-all duration-300`}>
                  <span className={`material-symbols-outlined text-secondary-container text-2xl`}>{s.icon}</span>
                </div>
              ...
              <span className="mt-6 flex items-center gap-2 text-secondary-container text-sm font-bold group-hover:gap-3 transition-all duration-300">
      ...
      <section className="py-28 bg-surface-container-low/50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-16">
            <div>
              <h2 className="text-4xl md:text-5xl font-display text-white mb-6 tracking-tight">Built on Trust, Delivered with <span className="text-accent">Precision</span></h2>
              <div className="w-20 h-0.5 bg-gradient-to-r from-secondary-container to-transparent" />
            </div>
            <p className="text-on-surface-variant text-lg font-light leading-relaxed">Our methodology combines internal network access with advanced digital forensics to ensure your online identity remains impenetrable and authentic.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: 'bolt', title: 'Fast Results', desc: 'Expedited processing times through direct platform partnerships and streamlined workflows.' },
              { icon: 'analytics', title: 'High Success Rate', desc: 'Proven track record of success in complex cases where others have failed.' },
              { icon: 'verified_user', title: 'Trusted Process', desc: 'Fully transparent and secure engagement protocols protecting your data at every step.' },
              ...
              <div key={i} className="flex flex-col p-6 rounded-2xl hover:bg-white/[0.02] transition-all duration-300">
                <div className="w-12 h-12 rounded-xl bg-secondary-container/10 flex items-center justify-center mb-5 border border-white/5">
      ...
      <section className="py-28 px-6">
        <div className="max-w-5xl mx-auto rounded-3xl glass-card p-12 md:p-24 text-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-80 h-80 bg-secondary-container/5 blur-[100px] rounded-full translate-x-1/3 -translate-y-1/3" />
          <div className="relative z-10">
            <h2 className="text-4xl md:text-6xl font-display text-white mb-6 tracking-tighter">Ready to Take Control of Your <span className="text-accent">Digital Presence?</span></h2>
            <p className="text-on-surface-variant text-lg md:text-xl mb-12 max-w-2xl mx-auto opacity-80">Join the exclusive list of brands and creators who trust our agency with their digital legacy.</p>
