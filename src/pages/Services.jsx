...
export default function Services() {
  return (
    <main className="pt-28 pb-16 px-6">
      ...
      {/* Services Bento Grid */}
      <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-5">
        ...
        <Link to="/services/verification" className="md:col-span-8 bg-surface-container rounded-2xl p-6 md:p-10 flex flex-col md:flex-row gap-8 items-center border border-white/5 group hover:bg-surface-container-high transition-all duration-500 cyan-glow block relative overflow-hidden">
          <div className="flex-1 relative z-10">
            ...
            <p className="text-on-surface-variant mb-6 leading-relaxed text-base">
          ...
          <div className="w-full md:w-2/5 aspect-square rounded-xl overflow-hidden bg-background relative z-10 border border-white/5">
        ...
        <Link to="/services/reputation" className="md:col-span-4 bg-surface-container rounded-2xl p-6 md:p-7 border border-white/5 group hover:bg-surface-container-high transition-all duration-500 block relative overflow-hidden">
          <div className="relative z-10">
            <span className="material-symbols-outlined text-secondary-container mb-4 text-3xl block group-hover:scale-110 transition-transform duration-500" style={{ fontVariationSettings: "'FILL' 1" }}>shield_person</span>
            <h3 className="font-headline text-xl font-bold mb-3 text-white">Reputation Management</h3>
          ...
          <div className="h-36 rounded-xl overflow-hidden border border-white/5 opacity-40 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700">
        ...
        {/* Account Recovery */}
        <Link to="/services/recovery" className="md:col-span-4 bg-surface-container-low rounded-2xl p-6 md:p-7 border border-white/5 group hover:bg-surface-container transition-all duration-500 block relative overflow-hidden">
          <div className="relative z-10">
            <span className="material-symbols-outlined text-secondary-container mb-4 text-3xl block group-hover:scale-110 transition-transform duration-500" style={{ fontVariationSettings: "'FILL' 1" }}>key</span>
            <h3 className="font-headline text-xl font-bold mb-3 text-white">Account Recovery</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed mb-4">
        ...
        {/* Username Claim */}
        <Link to="/services/username" className="md:col-span-4 bg-surface-container rounded-2xl p-6 md:p-7 border border-white/5 group hover:bg-surface-container-high transition-all duration-500 block relative overflow-hidden">
          <div className="relative z-10">
            <span className="material-symbols-outlined text-secondary-container mb-4 text-3xl block group-hover:scale-110 transition-transform duration-500" style={{ fontVariationSettings: "'FILL' 1" }}>alternate_email</span>
            <h3 className="font-headline text-xl font-bold mb-3 text-white">Username Claim</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed mb-4">
        ...
        {/* Growth & Engagement */}
        <Link to="/services/growth" className="md:col-span-4 bg-surface-container-low rounded-2xl p-6 md:p-7 border border-white/5 group hover:bg-surface-container transition-all duration-500 block relative overflow-hidden">
          <div className="relative z-10">
            <span className="material-symbols-outlined text-secondary-container mb-4 text-3xl block group-hover:scale-110 transition-transform duration-500" style={{ fontVariationSettings: "'FILL' 1" }}>trending_up</span>
            <h3 className="font-headline text-xl font-bold mb-3 text-white">Growth &amp; Engagement</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed mb-4">
        ...
        <Link to="/services/branding" className="md:col-span-6 bg-surface-container rounded-2xl p-6 md:p-7 border border-white/5 group hover:bg-surface-container-high transition-all duration-500 flex gap-6 overflow-hidden block">
          <div className="flex-1 relative z-10">
            <span className="material-symbols-outlined text-secondary-container mb-4 text-3xl block group-hover:scale-110 transition-transform duration-500" style={{ fontVariationSettings: "'FILL' 1" }}>brush</span>
            <h3 className="font-headline text-xl font-bold mb-3 text-white">Graphic Design &amp; Branding</h3>
          ...
          <div className="hidden sm:block w-36 -mr-3 rounded-xl overflow-hidden border border-white/5 opacity-40 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700 h-full">
        ...
        {/* Website Development */}
        <Link to="/services/webdev" className="md:col-span-6 bg-surface-container rounded-2xl p-6 md:p-7 border border-white/5 group hover:bg-surface-container-high transition-all duration-500 flex gap-6 overflow-hidden block">
          <div className="flex-1 relative z-10">
            <span className="material-symbols-outlined text-secondary-container mb-4 text-3xl block group-hover:scale-110 transition-transform duration-500" style={{ fontVariationSettings: "'FILL' 1" }}>code_blocks</span>
            <h3 className="font-headline text-xl font-bold mb-3 text-white">Website Development</h3>
            <p className="text-on-surface-variant text-sm leading-relaxed">
        ...
        <Link to="/services/pr-media" className="md:col-span-12 bg-gradient-to-br from-surface-container-low to-surface-container rounded-2xl p-8 md:p-10 border border-white/5 flex flex-col lg:flex-row justify-between items-center gap-8 block relative overflow-hidden group">
          <div className="lg:w-1/2 relative z-10">
            <div className="flex items-center gap-3 mb-5">
              <span className="material-symbols-outlined text-secondary-container text-3xl group-hover:scale-110 transition-transform duration-500" style={{ fontVariationSettings: "'FILL' 1" }}>newspaper</span>
              <h3 className="font-headline text-2xl md:text-3xl font-bold text-white tracking-tight">Press &amp; Media Publishing</h3>
            </div>
            ...
            <div className="flex gap-4 flex-wrap">
              {['Forbes', 'Bloomberg', 'Yahoo News', 'Entrepreneur'].map((pub) => (
                <div key={pub} className="px-4 py-2 bg-white/5 rounded-lg border border-white/10 font-bold text-[10px] uppercase tracking-[0.2em] text-on-surface-variant group-hover:border-secondary-container/40 group-hover:text-white transition-all duration-300">{pub}</div>
              ))}
            </div>
          </div>
          <div className="w-full lg:w-2/5 aspect-video md:aspect-auto md:h-52 rounded-xl overflow-hidden border border-white/10 opacity-30 group-hover:opacity-100 group-hover:scale-105 transition-all duration-1000 relative">
      ...
      {/* CTA Section */}
      <section className="max-w-4xl mx-auto mt-16 text-center relative px-4">
        <div className="absolute inset-0 bg-secondary-container/10 blur-[100px] rounded-full opacity-50" />
        {/* Content Container (Card) */}
        <div className="relative z-10 bg-surface-container-low/40 backdrop-blur-xl border border-white/10 p-10 md:p-14 rounded-[2rem] shadow-2xl overflow-hidden group">
          ...
          <div className="relative z-20">
            <h2 className="font-headline text-3xl sm:text-4xl md:text-5xl font-bold mb-4 tracking-tight">Let's Build Your Digital Authority</h2>
            <p className="text-on-surface-variant text-base sm:text-lg mb-8 max-w-xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link to="/contact" className="btn-secondary min-w-[180px]">
                Talk to an Expert
              </Link>
            </div>
          </div>
